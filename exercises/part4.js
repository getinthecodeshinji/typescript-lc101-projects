...
var bigShip = new Spacecraft('Determination', 17500);
console.log("The " + bigShip.type + " " + bigShip.name + " will take " + bigShip.getDaysToLocation(kilometersToMars) + " days to get to Mars.");
